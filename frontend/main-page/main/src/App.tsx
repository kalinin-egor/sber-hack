          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            >
              <TabsList className="grid w-full grid-cols-2 mb-10 h-14 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg border">
                ...
                <TabsTrigger 
                  value="animals" 
                  className="flex items-center gap-3 text-base data-[state=active]:bg-gradient-to-r data-[state=active]:from-emerald-500 data-[state=active]:to-teal-600 data-[state=active]:text-white"
                >
            ...
            <TabsContent value="animals">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <AnimalManagement transcriptionData={transcriptions} />
              </motion.div>
            </TabsContent>
          </Tabs>
        </motion.div>
        ...
        >
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border">
            <p className="text-muted-foreground mb-4">
              Анализатор аудио с функциями записи речи для животных и управления данными
            </p>
